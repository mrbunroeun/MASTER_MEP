...
export default function Create({ auth, services = [] }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.feature-project-card.store"), { forceFormData: true });
    };

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title="Add Feature Project Card" />
            <div className="max-w-2xl mx-auto px-4 py-10">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#1A3A5C]">Add Feature Project Card</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 bg-white rounded-2xl shadow p-8">
                    ...
                    <div>
                        ...
                        <input type="text" value={data.title}
                            ...
                            placeholder="e.g. Featured Project Highlight" />
