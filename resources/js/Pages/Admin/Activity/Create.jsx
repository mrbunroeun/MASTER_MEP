...
export default function Create() {
    ...
    <RichTextEditor
        ...
        placeholder="Write the full article here — use Heading for section titles like 'Introduction', 'Choosing the Right System', etc."
    />
    {errors.content && <p className="text-red-500 text-xs mt-1">{errors.content}</p>}
</div>

                    <div>
                        <label className="block text-sm font-medium mb-1">Main Image <span className="text-gray-400 font-normal">(max 10MB)</span></label>
                        <input
                            type="file"
                            accept="image/*"
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1">Gallery Images <span className="text-gray-400 font-normal">(max 10MB each)</span></label>
                        <input
                            type="file"
                            accept="image/*"
                            multiple
