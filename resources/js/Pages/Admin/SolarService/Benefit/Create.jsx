...
export default function Create({ items = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post("/admin/solar-service/benefit");
    };

    return (
        <AuthenticatedLayout>
            <Head title="Add Solar Benefit" />
            <div className="max-w-2xl mx-auto px-4 py-10">
                <BackToDashboard />
                <h1 className="text-2xl font-bold text-[#1A3A5C] mb-6">Add Solar Benefit</h1>
                ...
                <form onSubmit={submit} className="space-y-4 bg-white border border-gray-200 rounded-xl p-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1A3A5C]"
                            placeholder="e.g. Lower electricity costs"
                        />
                    ...
                    >
                        {processing ? "Saving..." : "Create Benefit"}
                    </button>
                </form>
            </div>
        </AuthenticatedLayout>
